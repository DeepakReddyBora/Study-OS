    ...
    <div className="min-h-screen bg-zinc-950 flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="card p-8">
          ...
          <p className="text-zinc-400 text-sm mb-8">Start building your personalized study plan</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <input type="text" name="name" value={form.name} onChange={handleChange} placeholder="Alex Johnson" required className="input-field"/>
            </div>
            <div>
